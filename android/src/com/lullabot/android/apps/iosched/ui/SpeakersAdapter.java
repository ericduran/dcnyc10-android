 ...
 */
public class SpeakersAdapter extends CursorAdapter {
    ...
    public long getItemId(int position) {
        ...
        if (mHasAllItem && position == 1) {
        	// DEBUG THE ITERM COUNT BEING CLICKS ON WHEN DISPLAY STARRED.
        	// Do this on the TRACK LISTER. TAKE THAT VALUE AND US it for
        	// the STARED POSITION which is 1 
            return 4;
        }
